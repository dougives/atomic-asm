...
extern void atomic_decrement32(volatile uint32_t* addr);
extern void atomic_decrement64(volatile uint64_t* addr);

extern uint64_t atomic_xadd64(volatile uint64_t* addr, uint64_t value);
extern uint32_t atomic_xadd32(volatile uint32_t* addr, uint32_t value);
